...
[extra]
image = "/blog/kroki-pluto-01/kroki_pluto_01_fig1.png"
+++

<!-- # Kroki + Pluto = ❤ -->

## Intro to [Pluto.jl](https://github.com/search?q=Pluto.jl&type=Repositories)

[Pluto.jl](https://github.com/search?q=Pluto.jl&type=Repositories) is a package for Julia for creating reactive notebooks in your browser. A notebook is a series of cells of code which display their outputs inline. When a function or variable is changed in the Pluto, all affected cells are updated automatically. When you add user interface elements such as sliders, buttons, and text fields with [PlutoUI.jl](https://github.com/search?q=PlutoUI.jl&type=Repositories), a Pluto notebook becomes a powerful way to explore code interactively.
...
Static diagrams can be made using a variety of string macros provided by [Kroki.jl](https://github.com/search?q=Kroki.jl&type=Repositories). For example a PlantUML sequence diagram can be made using the `plantuml` string macro:
