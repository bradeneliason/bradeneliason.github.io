...
[extra]
math = true
image = "/blog/diagnostic-tests-02/diagnostic_tests_02_fig1.png"
+++

![Diagnostic Test Visualization with Linear Scale from previous post](diagnostic_tests_02_fig1.png)

[View the full Julia source for this post](diagnostic_tests_02.jl)
...
savefig(joinpath(@__DIR__, "output", "diagnostic_tests_02_fig2.svg"))
```

![Plot of logit function with asymptotes at 0 and 1](diagnostic_tests_02_fig2.svg)
...
begin
    ...
    savefig(joinpath(@__DIR__, "output", "diagnostic_tests_02_fig3.svg"))
end
```

![Plot of bounded scaling function and its inverse](diagnostic_tests_02_fig3.svg)
...
![Diagnostic Test Visualization](diagnostic_tests_02_fig4.jpg)

I could have stopped with the image above, but I wasn't quite satisfied. I wanted my visualization to be interactive. I fired up an interactive [Pluto.jl](https://github.com/search?q=Pluto.jl&type=Repositories) notebook and created a visualization which reacts to input from a few sliders. The graphic was made with [Luxor.jl](https://github.com/search?q=Luxor.jl&type=Repositories). [Luxor.jl](https://github.com/search?q=Luxor.jl&type=Repositories) isn't meant to be interactive, but [Pluto.jl](https://github.com/search?q=Pluto.jl&type=Repositories) notebooks are reactive. When I update the value of a slider, the notebook automatically updates all the affected code including the code which generates the visualization. I may explore using [Javis.jl](https://github.com/search?q=Javis.jl&type=Repositories) in the future for smoother animations. I'm pretty pleased with the outcome and there's still a lot more that could be done.

![Animated Diagnostic Test Visualization](diagnostic_tests_02_fig5.gif)
