...
[extra]
math = true
image = "/blog/tolerance-analysis-01/tolerance_analysis_01_fig1.png"
+++
...
![Tolerance stack up](tolerance_analysis_01_fig1.png)
...
![Tolerance analysis example](tolerance_analysis_01_fig2a.png)
...
![Tolerance analysis example, variable names](tolerance_analysis_01_fig2b.png)
 ...
 * I've only demonstrated doing the RSS statistical tolerance analysis method. I may write a quick function to do worst-case analysis using [Measurements.jl](https://github.com/search?q=Measurements.jl&type=Repositories)—stay tuned.
 ...
 * This method is also compatible with [Unitful.jl](https://github.com/search?q=Unitful.jl&type=Repositories). This means that you could give units to each dimension vector and the calculation proceeds without any additional monkey business. I haven't shown this here, but it does work. Using [Unitful.jl](https://github.com/search?q=Unitful.jl&type=Repositories) may be particularly useful if you're compelled to use mixed imperial and metric dimensions.

### Future Work

There is still a lot that could be done. I've considered creating a package to perform tolerance analysis, but for now I'm happy with using [Measurements.jl](https://github.com/search?q=Measurements.jl&type=Repositories). More refined statistical tolerance analysis processes could probably still use Julia, but I believe I'll need to use one of the probabilistic programming packages ([Soss.jl](https://github.com/search?q=Soss.jl&type=Repositories), [Turing.jl](https://github.com/search?q=Turing.jl&type=Repositories), and [Gen.jl](https://github.com/search?q=Gen.jl&type=Repositories)) to perform uncertainty propagation with arbitrary distributions. Here are some features that could be part of a Julia package specifically for tolerances:
 ...
 * Integration with [Plots.jl](https://github.com/search?q=Plots.jl&type=Repositories) (this would be interesting).
